...
public class MemberSecurityController {
    ...
    @Operation(summary = "아이디 찾기 - 인증메일 발송")
    ...
    @Operation(summary = "아이디 찾기 - 인증번호 검증")
    ...
    @Operation(summary = "내 비밀번호 변경 (로그인 상태)")
    ...
    @Operation(summary = "비밀번호 찾기 - 인증메일 발송")
    ...
    @Operation(summary = "비밀번호 재설정 (계정 찾기 후)")
    ...
    @Operation(summary = "2차 인증(TOTP) QR 코드 발급")
    ...
    @Operation(summary = "2차 인증(TOTP) 활성화")
    ...
    @Operation(summary = "2차 인증(TOTP) 해제")
    ...
    @Operation(summary = "2차 인증(TOTP) 상태 조회")
